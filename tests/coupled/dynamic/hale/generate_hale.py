...
roll = 1.21439932e-5
gravity = 'on'
cs_deflection = -5.31012763e-2
rudder_deflection = 7.5622544e-5
thrust = 7.76392575
sigma = 1.5
lambda_dihedral = 20*np.pi/180
# 1.25325795e-01, -4.56919801e-07, 1.21439932e-05,
# -5.31012763e-02, 7.56225444e-05, 7.76392575e+00
# trim sigma = 100
...
def generate_solver_file():
    ...
    settings['StepUvlm'] = {'print_info': 'off',
                            ...
                            'velocity_field_input': {'turbulent_field':
                                                         '/home/ad214/Code/test_turbsim/TurbSim_wide_long_A.h5',
                                                     'offset': [30., 0., -10],
                                                     'u_inf': 0.},
